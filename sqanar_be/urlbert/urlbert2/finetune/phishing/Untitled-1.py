...
dataPreprocessFromCSV("/home/injeolmi/myproject/sQanAR/urlbert2-20250616T232219Z-1-001/urlbert2/dataset/train.csv", input_ids, input_types, input_masks, label)
...
config = AutoConfig.from_pretrained("home/injeolmi/myproject/sQanAR/urlbert2-20250616T232219Z-1-001/urlbert2/bert_config", **config_kwargs)
print(config)
...
# %%
bert_dict = torch.load("/home/injeolmi/myproject/sQanAR/urlbert2-20250616T232219Z-1-001/urlbert2/bert_model/urlbert (1).pt")
